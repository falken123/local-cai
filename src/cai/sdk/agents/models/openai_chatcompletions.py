...
class OpenAIChatCompletionsModel(Model):
    ...
    async def get_response(
        ...
        with generation_span(
            ...
            # https://www.redacted.redacted.redacted/news/token-saving-updates
    ...
    async def _fetch_response(
        ...
        if "alias" in model_str and "alias1.5" not in model_str:  # NOTE: exclude alias1.5
            kwargs["api_base"] = "https://api.redacted.redacted.redacted:666/"
            ...
            if provider == "ollama_cloud":
                ...
                ollama_api_base = os.getenv("OLLAMA_API_BASE", "https://redacted.redacted.redacted")
        ...
        if is_ollama_cloud:
            ...
            try:
                ...
                ollama_base_url = os.getenv("OLLAMA_API_BASE", "https://redacted.redacted.redacted")

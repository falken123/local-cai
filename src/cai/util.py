...
class CostTracker:
    ...
    def get_model_pricing(self, model_name: str) -> tuple:
        ...
        try:
            ...
            # try:
            #     import requests
            #     test_response = requests.get("https://redacted.redacted.redacted/", timeout=1)
...
def get_ollama_api_base():
    ...
    - OPENAI_BASE_URL: For Ollama Cloud or other OpenAI-compatible services (e.g., https://redacted.redacted.redacted/api/v1)
    """
    ...
    if openai_base and "redacted.redacted.redacted" in openai_base:
        return openai_base
...
def get_model_input_tokens(model):
    ...
    model_tokens = {
        ...
        "o1": 200000,
        "claude": 200000,
        "qwen2.5": 32000,  # https://redacted.redacted.redacted/library/qwen2.5, 128K input, 8K output  # noqa: E501  # pylint: disable=C0301
        "llama3.1": 32000,  # https://redacted.redacted.redacted/library/llama3.1, 128K input  # noqa: E501  # pylint: disable=C0301
        "deepseek": 128000,  # https://api-docs.redacted.redacted.redacted/quick_start/pricing  # noqa: E501  # pylint: disable=C0301
    }
